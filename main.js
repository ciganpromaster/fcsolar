...
const translations = {
    sk: {
        ...
        seo_contact_desc_ba_nr: "O všetku administratívu, vrátane komunikácie s vaším distribútorom – <strong>ZSDIS</strong>, sa kompletne postaráme my. Máme všetky potrebné platné elektrotechnické certifikácie pre profesionálnu inštaláciu. Od vás potrebujeme len list vlastníctva k rodinnému domu.",
        seo_contact_desc_ke: "O všetku administratívu, vrátane komunikácie s vaším distribútorom – <strong>VSD</strong>, sa kompletne postaráme my. Máme všetky potrebné platné elektrotechnické certifikácie pre profesionálnu inštaláciu.",
        seo_contact_desc_za: "O všetku administratívu, vrátane komunikácie s vaším distribútorom – <strong>SSD</strong>, sa kompletne postaráme my. Máme všetky potrebné platné elektrotechnické certifikácie pre profesionálnu inštaláciu.",
    ...
    en: {
        ...
        seo_contact_desc_ba_nr: "We will take complete care of all administration, including communication with your distributor – <strong>ZSDIS</strong>. We have all the necessary valid electrical engineering certifications for professional installation. You only need to provide the title deed to your family house.",
        seo_contact_desc_ke: "We will take complete care of all administration, including communication with your distributor – <strong>VSD</strong>. We have all the necessary valid electrical engineering certifications for professional installation.",
        seo_contact_desc_za: "We will take complete care of all administration, including communication with your distributor – <strong>SSD</strong>. We have all the necessary valid electrical engineering certifications for professional installation.",
