...
const translations = {
    ...
    en: {
        ...
        seo_contact_desc_ba_nr: "We take complete care of all administration and bureaucracy for you. As your professional partner, we manage everything, including communication with your distributor – <strong>ZSDIS</strong> and verifying the reserved connection capacity. With FC Solar, you won't have to deal with any paperwork; we handle all the work for you, requiring only your title deed to get started.",
